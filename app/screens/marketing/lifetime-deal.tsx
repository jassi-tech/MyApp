        ...
        <View style={styles.heroSection}>
          ...
          >
            ...
            <View style={styles.heroTextContent}>
              <ThemedText
                style={[styles.heroBadge, { fontSize: 12 * fontScale }]}
              >
                LIMITED TIME OFFER
              </ThemedText>
              <ThemedText
                style={[styles.heroTitle, { fontSize: 32 * fontScale }]}
              >
                Unlock Your{"\n"}Future Today
              </ThemedText>
              <ThemedText
                style={[styles.heroSubtitle, { fontSize: 16 * fontScale }]}
              >
            ...
            <View style={styles.priceRow}>
              <View>
                ...
                <View style={styles.priceStack}>
                  ...
                  <ThemedText
                    style={[styles.salePrice, { color: colors.text }]}
                  >
                    $99
                  </ThemedText>
                </View>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            Alert.alert("Success", "Lifetime Deal unlocked!");
          }}
        >
          <LinearGradient
            colors={["#E35FF2", "#8F36FF"]}
