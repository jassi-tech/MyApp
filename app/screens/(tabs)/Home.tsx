  ...
  return (
    <ScreenContainer scrollable>
        ...
        <View style={styles.header}>
            <View style={styles.userInfo}>
                ...
                <View style={styles.titleContainer}>
                    ...
                    <ThemedText style={styles.welcomeText}>Let's learn something new</ThemedText>
                </View>
            </View>
        ...
        <View style={styles.searchContainer}>
            <Ionicons name="search-outline" size={16} color={Palette.gray} style={styles.searchIcon} />
            <TextInput 
        ...
        <View style={styles.grid}>
            ...
            <CategoryItem icon="videocam-outline" label="Courses" />
            <CategoryItem icon="trophy-outline" label="Reward" />
            <CategoryItem icon="play-circle-outline" label="Free Courses" />
            <CategoryItem icon="book-outline" label="BookStore" />
